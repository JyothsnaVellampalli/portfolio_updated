...
import Img from '../Images/Jyo Logo.png';

function Home() {
  return (
    <div id='home' style={{backgroundColor: 'black', color:'white', padding:'15px'}}>
    <Grid container spacing={3}>
        
        <Grid item xs={12} sm={4}>
        <img src={Img} style={{height:'300px', width:'300px', marginTop:'-10px'}}/>
        </Grid>
        <Grid item xs={12} sm={8}>
            ...
            I am interested in solving <br/>new problems and 
